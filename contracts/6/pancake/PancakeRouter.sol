...
contract PancakeRouter is IPancakeRouter02 {
  ...
  function swapExactTokensForTokens(
    ...
    SafeToken.safeTransferFrom(path[0], msg.sender, PancakeLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
  ...
  function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    SafeToken.safeTransferFrom(path[0], msg.sender, PancakeLibrary.pairFor(factory, path[0], path[1]), amountIn);
